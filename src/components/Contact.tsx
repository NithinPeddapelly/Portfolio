...
const Contact = () => {
  ...
  try {
    ...
    alert("You will receive an acknowledgment shortly — please check your spam folder if not visible!");
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-4">
            Let's Build Something <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-400">Amazing</span>
          </h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">Hyderabad,Telangana , India | Available for Reallocation & Remote Work  </p>
                  </div>
                </div>
              </div>
            </div>
